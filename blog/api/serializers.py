...
class BlogPostSerializer(serializers.ModelSerializer):
    ...
    #create a new field for dealing with production image sugnature issue
    ...
    def get_username_from_author(self,x):
        username=x.author.username
        return username

    def validate_image_url(self,blogpost):
...
#Build a brand new serializer for updating some fileds ie title,body and image.
